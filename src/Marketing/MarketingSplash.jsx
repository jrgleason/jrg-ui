        ...
        >
            <Box
                ...
                sx={{
                    ...
                    borderRadius: '20px',
                    maxHeight: '300px',
                    backgroundColor: (theme) => `${theme.palette.primary.main}CC`, // Use a semi-transparent version of the primary color
                }}
            >
                <Typography
                    variant="h1"
                    component="div"
                    sx={{
                        color: (theme) => theme.palette.primary.contrastText, // Use contrastText color from your theme
                        flexGrow: 1,
                        textAlign: 'center',
                        padding: '25px',
                    }}
